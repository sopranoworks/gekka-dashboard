...
func TestApplyManagementDefaults_OverridesLoadConfigDefault(t *testing.T) {
	cfg := &gekka.ClusterConfig{}
	// Simulate DefaultManagementConfig() values as set by LoadConfig.
	cfg.Management.Hostname = "127.0.0.1"
	cfg.Management.Port = 8558
	cfg.Management.Enabled = false
	cfg.Management.HealthChecksEnabled = true
...
func TestApplyManagementDefaults_RespectsExplicitHostname(t *testing.T) {
	cfg := &gekka.ClusterConfig{}
	cfg.Management.Hostname = "0.0.0.0"
	applyManagementDefaults(cfg, false)
